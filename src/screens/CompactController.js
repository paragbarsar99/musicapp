...
import {
  SongObjAction,
  InitialValueOfSetupPlayerAction,
  SetupPlayer,
} from '../Actions';
...
export function CompactController() {
  ...
  const {
    Obj: {title, artwork, duration, artist},
  ...
  async function pause() {
    await TrackPlayer.pause().catch(error =>
  ...
  async function skiptonext() {
    try {
      await TrackPlayer.skipToNext()
        ...
        .catch(error => console.log(`Error inside skiptonext is ${error}`));
    } catch (e) {
  ...
  async function skiptoprevious() {
    try {
      await TrackPlayer.skipToPrevious()
        .then(() => TrackPlayer.play())
        .catch(error => console.log(`Error inside skiptoprevious is ${error}`));
    } catch (e) {
