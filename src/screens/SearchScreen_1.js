...
export function SearchScreen_1() {
  ...
  const {
    AllSearch: {
      data: {users, tracks, playlists, albums},
      error,
    },
    Name,
  ...
  return (
    <View style={styles.container}>
      <SearchBar
        ...
        onClear={() => {
          setSearchValue(''), setisLoading(false);
        }}
          ...
          {error === null ? (
                ...
                <TouchableOpacity
                  ...
                  onPress={() => {
                    if (users[0].profile_picture) {
                      Navigation.navigate('ArtistSongScreen', {
                        ...
                        cover_image:
                          users[0].profile_picture['150x150'] ||
                  ...
                  <View style={styles.artistContainer}>
                    {users[0].profile_picture ? (
                      <Image
                        source={{uri: `${users[0].profile_picture['150x150']}`}}
            ...
            <>
              <Text style={styles.helpMessage}>
                {' '}
                Search What You Like,Artist,Song,Albums🙂
              </Text>
            </>
          ) : (
